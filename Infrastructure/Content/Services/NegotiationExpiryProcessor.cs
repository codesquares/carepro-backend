    ...
    public class NegotiationExpiryProcessor : BackgroundService
    {
            ...
            ILogger logger)
        {
            try
            {
                ...
                await emailService.SendGenericNotificationEmailAsync(client.Email, client.FirstName, subject, html, includeUnsubscribeHeader: true);
            }
            catch (Exception ex)
            {
            ...
            ILogger logger)
        {
            try
            {
                ...
                await emailService.SendGenericNotificationEmailAsync(caregiver.Email, caregiver.FirstName, subject, html, includeUnsubscribeHeader: true);
            }
            catch (Exception ex)
            {
                logger.LogWarning(ex,
