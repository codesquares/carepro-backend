...
{
    /// <summary>
    /// RETIRED. This used to serve an anonymous Open Graph "share this gig" page that advertised a gig
    /// (title, image, price) and redirected visitors to the public gig page. Gigs are no longer
    /// client-purchasable and the public gig page (/service/:id) is retired, so there is nothing left to
    /// advertise. Responds 410 Gone for every id — including ones that don't exist, so it also stops
    /// revealing which gig ids are real. The original implementation is preserved, commented out, below.
    /// </summary>
    ...
    {
        [HttpGet("gig/{gigId}")]
        public IActionResult ShareGig(string gigId) =>
            StatusCode(StatusCodes.Status410Gone, "Gig sharing has been retired.");
    }
}

// ─────────────────────────────────────────────────────────────────────────────────────────────
// Original implementation (retired) — preserved for reference only.
// ─────────────────────────────────────────────────────────────────────────────────────────────
